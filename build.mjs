...
const ORDER = ['utils.js', 'data.js', 'galaxy.js', 'landmarks.js', 'solar.js', 'blackhole.js', 'orion.js', 'localgroup.js', 'alphacentauri.js', 'discoveries.js', 'routes.js', 'ui.js', 'main.js'];
